...
const hotQuestion = [
  ...
  { _id: "4", title: "What are the new features in React 18 ? " },
...
const RightSideBar = () => {
  return (
    ...
    background-light900_dark200 light-border sticky right-0 top-0 flex h-screen w-[350px] flex-col gap-6 overflow-y-auto border-l
    p-6 shadow-light-300 dark:shadow-none max-xl:hidden"
    >
      <div>
        <h3 className="h3-bold text-dark200_light900 ">Top Questions</h3>
        {/* container for top questions */}
        <div className="flex w-full flex-col gap-[30px]">
          {hotQuestion.map(({ title, _id }) => (
            <Link
